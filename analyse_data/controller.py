...
if __name__ == '__main__':
    # print(db_get_tb_apps())
    # print(db_get_appinformation_by_package('com.fsj'))
    # print(db_get_daydownloads_by_day('com.fsj'))
    # print(db_get_totaldownloads('com.youcash.ZYWallet'))
    print(db_get_totaldownloads('com.zl.fqbao'))
